<template>
  <WelcomeItem>
    <template #icon>
      <span class="i-vue-documentation size-5"></span>
    </template>
    <template #heading>
      Documentation
    </template>
  ...
  <WelcomeItem>
    <template #icon>
      <span class="i-vue-tooling size-5"></span>
    </template>
    <template #heading>
      Tooling
    </template>
  ...
  <WelcomeItem>
    <template #icon>
      <span class="i-vue-ecosystem size-5"></span>
    </template>
    <template #heading>
      Ecosystem
    </template>
  ...
  <WelcomeItem>
    <template #icon>
      <span class="i-vue-community size-5"></span>
    </template>
    <template #heading>
      Community
    </template>
  ...
  <WelcomeItem>
    <template #icon>
      <span class="i-vue-support size-5"></span>
    </template>
    <template #heading>
      Support Vue
    </template>
